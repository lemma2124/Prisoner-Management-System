...
public class ManagePrisoner extends JFrame implements ActionListener {

    

    JButton add, remove, search, update, display, back;
  
    JLabel title, subTitle, addLabel, repLabel, sepLabel, upLabel, dipLabel,inserlabel;
    ...
    public ManagePrisoner() {
        ...
        inserlabel=new JLabel();
        inserlabel.setBounds(50, 150, 80, 80);
        ...
        subTitle = new JLabel("Manage Prisoners");
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       new UpdatePrisonerInfo();
        ...
        if(e.getSource()==display){
            this.dispose();
            DisplayPrisonerList PrisonerList = new DisplayPrisonerList();
